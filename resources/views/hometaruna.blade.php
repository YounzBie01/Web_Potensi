...
<head>
    ...
    <link rel="stylesheet" href="css/styletaruna.css">
...
<body>
    ...
    <nav class="navbar navbar-expand-md fixed-top">
        <div class="container">
            <a href="/hometaruna"><img class="nvtaruna me-4" src="logo/karang_taruna.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav m-auto mb-2 mb-md-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/hometaruna">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Info Covid-19</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/homebumdes">BUMDes <i class="fas fa-arrow-circle-right"></i></a>
                    </li>
                </ul>
  ...
  ================================================== -->
    ...
    <div class="container-fluid footer">
        <div class="me-3 text-end">
            <a href="" class="btn" id="bantu"><i class="fab fa-whatsapp"></i>
                <h6>Ada yang bisa dibantu?</h6>
            </a>
        </div>
