...
@section('container')
<h2 class="text-center mt-4">Pelindung</h2>
<div class="container" id="itemsotk">
    <div class="row">
        <div class="col-md-4">
        <img src="logo/bumdesp.png" alt="" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        </div>
        <div class="col-md-4">
            <p>Nama Lengkap : </p>
            <p>HP :</p>
...
<hr>
<h2 class="text-center mt-4">Ketua</h2>
<div class="container" id="itemsotk">
    <div class="row">
        <div class="col-md-4">
        <img src="logo/bumdesp.png" alt="" class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
...
<hr>
<h2 class="text-center mt-4">Sekretaris</h2>
<div class="container mt-3" >
    <div class="row" id="itemsotkother">
        <div class="col-md-5">
            <div>
                <img src="logo/bumdesp.png" alt="" class="bd-placeholder-img rounded-circle" width="120" height="120" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
            </div>
            <div class="bio">
                <p>Nama Lengkap : </p>
                <p>HP :</p>
...
<hr>
<h2 class="text-center mt-4">Bendahara</h2>
<div class="container mt-3">
    <div class="row"  id="itemsotkother">
        <div class="col-md-5">
            <div>
...
<hr>
<h2 class="text-center mt-4">Humas</h2>
<div class="container mt-3" >
    <div class="row" id="itemsotkother">
        <div class="col-md-5">
            <div>
